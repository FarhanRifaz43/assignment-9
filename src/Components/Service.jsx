        ...
        <div className="flex flex-col flex-grow">
            ...
            <div>
                ...
                <div className="card-actions">
                    <Link to={`/services/${id}`} className="w-full mx-5 mb-4 mt-6 rounded-md py-1 bg-gray-300 hover:bg-purple-600 hover:text-white text-center"><button>Book Event</button></Link>
                </div>
            </div>
        </div>
        </div>
